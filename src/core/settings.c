...
void settings_load(void) {
    ...
    g_setting.speed.playback_keep_timing = settings_get_bool("speed", "playback_keep_timing", g_setting_defaults.speed.playback_keep_timing);
    ...
    LOGI("speed: boot_display_early=%s defer_menu=%s fast_efuse=%s dvr_stop_wait=%s dvr_start_wait=%s menu_async_display=%s dvr_defer_stop=%s playback_keep_timing=%s",
         ...
         g_setting.speed.playback_keep_timing ? "on" : "off");
